...
function M._register_scenes()
  ...
  local hub_inventory_consumables = require("scenes.hub.inventory_consumables")
  local hub_equipment = require("scenes.hub.equipment")
  ...
  scene_manager.register("hub.inventory_consumables", function() return hub_inventory_consumables.new() end)
  scene_manager.register("hub.equipment", function() return hub_equipment.new() end)
